...
def insert_bank(self):
    with open('C:\\Users\priya\\OneDrive\\Desktop\\django\priya\\Scripts\\project43\\app\\bank.csv','r') as FO:
        IOD=csv.reader(FO)
        for i in IOD:
            bn=i[0].strip()
...
def insert_branch(self):
    with open('C:\\Users\\priya\\OneDrive\\Desktop\\django\\priya\\Scripts\\project43\\app\\branch1.csv','r') as FO:
        IOD=csv.reader(FO)
        next(IOD)
        for i in IOD:
            bn=i[0]
